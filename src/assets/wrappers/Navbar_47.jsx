...
const Wrapper = styled.div`
  ...
  *::after {
  ...
  @media (max-width: 48em) {
    .header .header-row .header-right .Tku-demo {
      display: none;
    }
  }
  ...
  @media (min-width: 48em) {
    ...
    .header .header-row .header-right .Tku-demo li.menu-item {
      display: block;
    }

    .header .header-row .header-right .Tku-demo li.dropdown {
      position: relative;
    }

    .header .header-row .header-right .Tku-demo li.menu-item:not(:last-child) {
      margin: 0 20px 0 0;
    }

    .header .header-row .header-right .Tku-demo li.menu-item > a {
      font-size: 13px;
      font-weight: 600;
      line-height: 20px;
      color: #444444;
    ...
    .header .header-row .header-right .Tku-demo li.menu-item a.active {
      color: #e9900a;
    }

    .header .header-row .header-right .Tku-demo .sub-menu-wrapper {
      position: absolute;
      text-align: left;
      margin: 0;
      z-index: 111;
    ...
    .header .header-row .header-right .Tku-demo .dropdown ul.sub-menu {
      background-color: #ffffff;
      border-top: 3px solid #e9900a;
      min-width: 200px;
      padding: 0px 0;
    ...
    .header .header-row .header-right .Tku-demo .sub-menu-wrapper ul li:hover {
      background-color: #ededed;
    }

    /* Mega menu styles */
    .header .header-row .header-right .Tku-demo .mega-menu .mega-menu-wrapper {
      position: absolute;
      left: 0px;
      display: none;
      padding: 20px 25px;
